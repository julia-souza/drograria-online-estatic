...
<div class="row topo-site">
    <div class="col-md-2">
        <a href="http://localhost/drograria-online-estatic/index.php"><img src="img/6357977537_6429fb4333-removebg-preview.png" id="logo-topo" alt="logo"></a>
    </div>
    <div class="col-md-6">
        <div id="search-bar">
    ...
    <div class="col-md-2">
        <div id="cart-header">
            <a href="http://localhost/drograria-online-estatic/cart.php" class="cart-page">
